...
【STEP 2: Section Layout 選定（★Design System優先）】
  ...
  knowledge/design-system/layouts/feature-layout-library.md      ← Featureレイアウト（準備中）
...
3. hero-layout-library.md で詳細確認・選定
4. 他セクション（Feature/Voice/FAQ/Flow/CTA等）も対応ライブラリで選定
5. 各選定パターンを STEP 9 の LP設計書に記録する
```
...
| Feature | layouts/feature-layout-library.md | 準備中 |
