...
**作成日**: 2026-06-24
**更新日**: 2026-06-27
**ステータス**: Asset Management System 2.0 統合済み
...
4. knowledge/lp/emotional-triggers.md               ← 感情訴求トリガー（TRIG-XXX）
5. knowledge/lp/offer-library.md                    ← オファー設計パターン（OFFER-XXX）
6. knowledge/assets/industry-asset-patterns.md      ← 業種別素材構成（★NEW）
7. knowledge/assets/asset-management-rules.md       ← 素材管理ルール（★NEW）
8. knowledge/lp/cta-library.md                      ← CTAパターン（CTA-XXX）
9. knowledge/web/design-system.md                   ← デザイントークン・コンポーネント
10. knowledge/case-studies/                         ← 同業種の過去案件
```
