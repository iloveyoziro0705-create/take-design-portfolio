...
7.  knowledge/lp/cta-library.md                      ← CTAパターン（CTA-XXX）
8.  knowledge/design/visual-library.md               ← ビジュアルパターン（VISUAL-XXX）★必須
9.  knowledge/design/fv-visual-library.md            ← FVビジュアルレイアウト（FV-VISUAL-XXX）★必須
10. knowledge/design/industry-visual-patterns.md     ← 業種別ビジュアル仕様（IND-V-XXX）★必須
11. knowledge/design/image-direction-rules.md        ← 画像ディレクション・AIプロンプト
...
FVレイアウト選択（fv-library.md）
    ↓
FVビジュアル選択（fv-visual-library.md + industry-visual-patterns.md）★NEW
    ↓
FVコピー選択（fv-copy-library.md）★NEW
    ↓
感情設計（emotional-triggers.md）★NEW
    ↓
オファー設計（offer-library.md）★NEW
    ↓
